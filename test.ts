...
/**
 * TEST: Actions - call walk, sideStep, explore, stand, sit, rest, dance, kick, jump, blink commands
 * [HARDWARE]
...
function testReturnValues() {
    ...
    robotPuPro.sit();             basic.showNumber(1); basic.pause(200)
...
function testActionDone() {
    ...
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Walk)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Explore)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.sideStep(-1)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Dance)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Kick)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Jump)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Rest)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Stand)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Sit)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.start(robotPuPro.Action.Sit, 1)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.isDone(robotPuPro.Action.Sit)
    basic.showNumber(1); basic.pause(200)
    robotPuPro.stop()
