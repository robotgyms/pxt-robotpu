...
help:
	...
	@echo "  make release VERSION=v1.0.39 - update pxt.json, commit, push, tag, and push tag"
	@echo "  make tag VERSION=v1.0.39 - create a local release tag"
	@echo "  make push-tag VERSION=v1.0.39 - create and push a release tag"
